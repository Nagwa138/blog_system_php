...
<body>
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        <div class="row mb-4">
            <h2 class="col-12 tm-text-primary">Post create</h2>
        </div>
        <div class="row tm-mb-90 justify-content-center">
            <div class="col-md-8 col-10">

                <form class="tm-bg-gray tm-video-details" action="./post-create-back.php" method="post"
                ...
                ?>
                    <div class="mb-4 d-flex flex-column justify-content-center align-items-center">
                        <input class="form-control tm-search-input" type="text" name="title" placeholder="Title"
                            aria-label="Title">
                        <br>
                        <label for="formFile" class="form-label">Image</label>
                        <input class="form-control tm-search-input" name="image" type="file" id="formFile">
                    </div>
                    <div class="text-center mb-5">
                        <button class="btn btn-primary tm-btn-big">Create</button>
                    </div>
                </form>
            </div>
        </div>
