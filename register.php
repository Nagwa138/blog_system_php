        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link nav-link-2" href="./login.php">Login</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="tm-hero d-flex justify-content-center align-items-center" data-parallax="scroll"
        ...
        <form class="d-flex"
            ...
            <?php
                ...
                ?>
            <input class="form-control tm-search-input" type="text" name="first_name" placeholder="First name"
                aria-label="First name">
            <input class="form-control tm-search-input" type="text" name="last_name" placeholder="Last name"
                aria-label="Last name">
            <input class="form-control tm-search-input" type="email" name="email" placeholder="Email"
                aria-label="Email">
            <input class="form-control tm-search-input" type="date" name="date_of_birth" placeholder="Date of birth"
                aria-label="Email">
            <input class="form-control tm-search-input" type="password" name="password" placeholder="Password"
                aria-label="Date of birth">
            <input class="form-control tm-search-input" type="password" name="confirm" placeholder="Confirm"
                aria-label="Confirm">
